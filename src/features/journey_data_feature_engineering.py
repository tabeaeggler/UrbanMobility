...
def manual_borough_mapping(journey_df):
    ...
    journey_df.loc[journey_df['start_station_name'] == 'Contact Centre, Southbury House', 'start_borough'] = 'Enfield'
    ...
    journey_df.loc[journey_df['end_station_name'] == 'Contact Centre, Southbury House', 'end_borough'] = 'Enfield'
